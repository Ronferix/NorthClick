...
const TRANSLATIONS = {
  en: {
    ...
    'cat.tos.payment.d':   '50% upfront to start, 50% on delivery. Currently accepted via PayPal. More methods coming soon.',
    ...
    'contact.form.plan.o1': 'Landing Page — from $320 USD',
    'contact.form.plan.o2': 'Brochure / Professional Site — from $640 USD',
    'contact.form.plan.o3': 'E-commerce / Full Site — coming soon',
    'contact.form.plan.o4': 'Redesign or update — from $40 USD',
    'contact.form.plan.o5': 'SEO / Performance — from $40 USD',
    ...
    'contact.form.error.network':'Network error. Please check your connection and try again.',
    ...
    'contact.faq.a5': '50% upfront to start, 50% on delivery. We accept bank transfer (ACH/wire), PayPal, and Stripe (credit/debit card).',
  ...
  es: {
    ...
    'cat.tos.payment.d':   '50% por adelantado al iniciar, 50% a la entrega. Actualmente se acepta PayPal. Más métodos próximamente.',
    ...
    'contact.form.plan.o1': 'Landing Page — desde $320 USD',
    'contact.form.plan.o2': 'Brochure / Sitio Profesional — desde $640 USD',
    'contact.form.plan.o3': 'E-commerce / Sitio Completo — próximamente',
    'contact.form.plan.o4': 'Rediseño o actualización — desde $40 USD',
    'contact.form.plan.o5': 'SEO / Rendimiento — desde $40 USD',
    ...
    'contact.form.error':        'Ocurrió un error. Por favor intenta de nuevo o contáctanos directamente.',
    'contact.form.error.network':'Error de red. Por favor revisa tu conexión e intenta de nuevo.',
    ...
    'contact.faq.a5': '50% al inicio y 50% a la entrega. Aceptamos transferencia bancaria (ACH/wire), PayPal y Stripe (tarjeta de crédito/débito).',
